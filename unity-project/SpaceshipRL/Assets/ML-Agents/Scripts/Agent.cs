...
public abstract class Agent : MonoBehaviour
{
    ...
    /**  The list of the cameras the Agent uses as observations. */
    ...
    * Additionally, the magnitude of the reward should not exceed 1.0 */
    ...
    /** Do not modify: This keeps track of the cummulative reward.*/

    [HideInInspector]
    public int stepCounter;
    /** Do not modify: This keeps track of the number of steps taken by
     * the agent each episode.*/

    [HideInInspector]
    public float[] agentStoredAction;
    /** Do not modify: This keeps track of the last actions decided by
     * the brain.*/

    [HideInInspector]
    public float[] memory;
    /** Do not modify directly: This is used by the brain to store 
     * information about the previous states of the agent*/

    [HideInInspector]
    public int id;
    /** Do not modify : This is the unique Identifier each agent 
