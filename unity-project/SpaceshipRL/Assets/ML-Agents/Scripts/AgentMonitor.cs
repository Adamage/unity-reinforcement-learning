...
public class AgentMonitor : MonoBehaviour
{
    ...
    /** If true, the monitor will be fixed in the top left corner of 
     * the screen. If false, it will move with the position of the agent*/
    public float verticalOffset = 10f;
    /** If fixedPosition is false, defines how high above the agent 
     * the monitor is */
    [Header("Displayed Values")]
    public bool DisplayBrainName = true;
    /** If true, the name of the brain will be displayed in the monitor */
    public bool DisplayBrainType = true;
    /** If true, the type of the brain will be displayed in the monitor */
    public bool DisplayFrameCount = true;
    /** If true, the number of steps since the agent was reset will be displayed in the monitor */
    public bool DisplayCurrentReward = true;
    /** If true, the current reward of the agent will be displayed in the monitor */
    public bool DisplayMaxReward = true;
    /** If true, the maximum reward accros episodes will be displayed in the monitor */
    public bool DisplayState = false;
    /** If true, the current state of the agetn will be displayed in the monitor */
    public bool DisplayAction = false;
    /** If true, the current action of the agetn will be displayed in the monitor */
